...
response = ssm.get_parameter(Name="/clarusway/dbname")
dbname = response["Parameter"]["Value"]

response = ssm.get_parameter(Name="/clarusway/password")
...
app.config[
    "MYSQL_DATABASE_HOST"
] = "database-1.czvllzpyc8qb.us-east-1.rds.amazonaws.com"
...
def emails():
    if request.method == "POST":
        ...
        return render_template(
            "emails.html", name_emails=user_emails, keyword=user_name, show_result=True
        )
    else:
