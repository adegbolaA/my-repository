...
@app.route("/")
def home():
    return "This is home page with no path, <h1>Welcome Home</h1>"
...
@app.route("/about")
def about():
    return f"<h1>This is my about page </h1>"
...
@app.route("/error")
def error():
    return f"<h1>Either you encountered an error or you are not authorized. </h1>"
...
""" @app.route("/<name>")
def greet(name):
    return f"Welcome {name} to my Page" """
